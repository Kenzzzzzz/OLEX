...
<!-- Navbar Section -->
    <Nav>
        ...
        <a class="navbar-brand" href="Customer.php"><h2><i class="fa fa-cart-plus" aria-hidden="true"></i> OLEX - PARTNER </h2></a>    
        <h3><i class="fa-solid fa-magnifying-glass"></i></h3><h3><input type="search" id="search" name="search"></h3>
            <ul class="nav_menu">
                ...
                <li><a href="Upload.php"><h3><i class="fa-solid fa-plus"></i></h3></a></li>
...
<section class="categories">
        <div class="container categories_container">
            <div class="categories_right">
                <?php
                if ($categoryCount > 0) {
                    echo "<h3>What You Are Selling:</h3>";
